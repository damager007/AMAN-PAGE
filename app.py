...
body{
    background-image: url('https://imgur.com/EQ96vo0.jpeg');
...
<body>
  ...
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="kidx" class="form-label">H𝙰𝚃ᴇꜱ 𝙽𝙰𝙼𝙴</label>
  ...
  <footer class="footer">
    <p>&copy; 2024 ᴩᴏᴡᴇʀ ʜᴏᴜꜱᴇ</p>
    <p><a href="fb id link">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+number" class="whatsapp-link">
